...
proc DrawShape
	 ...
	 cmp [ShapeKind],5
	 jz @@Draw_Two_Squares_Up_Right
	 
	 cmp [ShapeKind],6
	 jz @@Draw_Two_Squares_Down_Left
	 
	 cmp [ShapeKind],7
	 jz @@Draw_Two_Squares_Up_Left
...
@@Draw_Two_Squares_Up_Right:;5
	 call Draw_Two_Squares_Up_Right_Shape

@@Draw_Two_Squares_Down_Left:;6
	 call Draw_Two_Squares_Down_Left_Shape

@@Draw_Two_Squares_Up_Left:;7
	 call Draw_Two_Squares_Up_Left
...
proc GetShapeColor
	 ...
	 cmp [ShapeKind],4
	 jbe Get_Two_Squares_Down_Right_Shape_Color ;	 jz Get_Two_Squares_Down_Right_Shape_Color
...
;5
proc Draw_Two_Squares_Up_Right_Shape
	 push cx
	 push dx
	 ...
	 pop cx
	 ret
endp Draw_Two_Squares_Up_Right_Shape

;6
proc Draw_Two_Squares_Down_Left_Shape
	 push cx
	 push dx
	 
	 call Draw_One_Square_Shape
	 
	 sub cx, CELL_WIDTH_IN_SCREEN ; not -1 because we want to draw two squars with a space for a border between them.
	 call Draw_One_Square_Shape
	 ...
	 pop cx
	 ret
endp Draw_Two_Squares_Down_Left_Shape

;7
proc Draw_Two_Squares_Up_Left_Shape
	 push cx
	 push dx
	 ...
	 pop cx
	 ret
endp Draw_Two_Squares_Up_Left_Shape
